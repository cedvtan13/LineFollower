...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PB1 ------> ADC1_IN9  (MUX SIG — analog input)
    */
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    /**ADC1 GPIO De-Configuration
    PB1 is now SENS5 (digital input) — managed by MX_GPIO_Init.
    */
...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  else if(hi2c->Instance==I2C3)
  {
    ...
    */
    ...
    HAL_GPIO_Init(ACCEL_SCL_GPIO_Port, &GPIO_InitStruct);
    ...
    HAL_GPIO_Init(ACCEL_SDA_GPIO_Port, &GPIO_InitStruct);
